...
@click.command()
@click.option('-i', 'input_dir', required=True, help="Path to input dir")
@click.option('-l', 'lab_id', required=True, help="Path to input dir")

def main(input_dir, lab_id):
    basepath = input_dir
    ...
    for f in files:
        ...
        with open(os.path.join(basepath, f), encoding='utf-8') as cs:
            ...
            for i in get_baserow_data("https://baserow-backend-psykcom.apps.k8s.gu.se/api/database/rows/table/11069/?user_field_names=true"):
                baserow_lab_id = i['Lab ID'][0]['value']

                if baserow_lab_id == lab_id:
                    ...
                    for key in survey_map[survey_name]:
                        ...
                        if qsf['SurveyElements'][id]['Payload']['Randomization']['Advanced']:
                            qsf['SurveyElements'][id]['Payload']['Randomization']['Advanced']['RandomSubSet'] = ChoiceOrder
            ...
            for i in get_baserow_data("https://baserow-backend-psykcom.apps.k8s.gu.se/api/database/rows/table/11070/?user_field_names=true"):
                ...
                if lab_id == baserow_lab_id:
                    ...
                    if survey_name == 'spatial':
                        QID6 = qsf['SurveyElements'][66]['Payload']['QuestionText']
                        ...
                        qsf['SurveyElements'][66]['Payload']['QuestionText'] = QID6

                        QID101 = qsf['SurveyElements'][65]['Payload']['QuestionText']
                        ...
                        qsf['SurveyElements'][65]['Payload']['QuestionText'] = QID101

                        QID112 = qsf['SurveyElements'][43]['Payload']['QuestionText']
                        QID112 = QID112.replace('[Distant Location]', distant_lower)
                        qsf['SurveyElements'][43]['Payload']['QuestionText'] = QID112

                        QID72 = qsf['SurveyElements'][42]['Payload']['QuestionText']
                        QID72 = QID72.replace('[Current Location]', current_lower)
                        qsf['SurveyElements'][42]['Payload']['QuestionText'] = QID72

                        ### CHOICES ####
                        QID71C1 = qsf['SurveyElements'][85]['Payload']['Choices']["1"]['Display']
                        ...
                        qsf['SurveyElements'][85]['Payload']['Choices']["1"]['Display'] = QID71C1

                        QID71C2 = qsf['SurveyElements'][85]['Payload']['Choices']["2"]['Display']
                        QID71C2 = QID71C2.replace('[Distant Location]', distant_lower)
                        QID71C2 = QID71C2.replace('[XXXX miles/XXXX km]', xxxx_distans_miles_km)
                        qsf['SurveyElements'][85]['Payload']['Choices']["2"]['Display'] = QID71C2

                        QID71C3 = qsf['SurveyElements'][85]['Payload']['Choices']["3"]['Display']
                        ...
                        qsf['SurveyElements'][85]['Payload']['Choices']["3"]['Display'] = QID71C3

                        QID71C4 = qsf['SurveyElements'][85]['Payload']['Choices']["4"]['Display']
                        ...
                        qsf['SurveyElements'][85]['Payload']['Choices']["4"]['Display'] = QID71C4

                        QID71C6 = qsf['SurveyElements'][85]['Payload']['Choices']["6"]['Display']
                        QID71C6 = QID71C6.replace('[a different country closest to the current location]', close_country)
                        qsf['SurveyElements'][85]['Payload']['Choices']["6"]['Display'] = QID71C6

                        QID71C7 = qsf['SurveyElements'][85]['Payload']['Choices']["7"]['Display']
                        QID71C7 = QID71C7.replace('[a different country far away from the current location]', far_country)
                        qsf['SurveyElements'][85]['Payload']['Choices']["7"]['Display'] = QID71C7

                        QID129C1 = qsf['SurveyElements'][86]['Payload']['Choices']["1"]['Display']
                        ...
                        qsf['SurveyElements'][86]['Payload']['Choices']["1"]['Display'] = QID129C1

                        QID129C2 = qsf['SurveyElements'][86]['Payload']['Choices']["2"]['Display']
                        ...
                        qsf['SurveyElements'][86]['Payload']['Choices']["2"]['Display'] = QID129C2

                        QID129C3 = qsf['SurveyElements'][86]['Payload']['Choices']["3"]['Display']
                        ...
                        qsf['SurveyElements'][86]['Payload']['Choices']["3"]['Display'] = QID129C3

                        QID129C4 = qsf['SurveyElements'][86]['Payload']['Choices']["4"]['Display']
                        ...
                        qsf['SurveyElements'][86]['Payload']['Choices']["4"]['Display'] = QID129C4

                        QID129C6 = qsf['SurveyElements'][86]['Payload']['Choices']["6"]['Display']
                        QID129C6 = QID129C6.replace('[a different country closest to the current location]', close_country)
                        qsf['SurveyElements'][86]['Payload']['Choices']["6"]['Display'] = QID129C6

                        QID129C7 = qsf['SurveyElements'][86]['Payload']['Choices']["7"]['Display']
                        QID129C7 = QID129C7.replace('[a different country far away from the current location]', far_country)
                        qsf['SurveyElements'][86]['Payload']['Choices']["7"]['Display'] = QID129C7
                        ...
                        qsf['SurveyElements'][40]['Payload']['QuestionText'] = QID1211340211
                        ...
                        qsf['SurveyElements'][41]['Payload']['QuestionText'] = QID1211340228
                        ...
                        QID1211339847 = QID1211339847.replace('[3 miles/5 km]',
                                                              '3 miles' if miles_km == 'miles' else '5 km')
                        qsf['SurveyElements'][52]['Payload']['QuestionText'] = QID1211339847
                        ...
                        qsf['SurveyElements'][53]['Payload']['QuestionText'] = QID1211339848
                        ...
                        QID1211340641 = QID1211340641.replace('[3 miles/5 km]',
                                                              '3 miles' if miles_km == 'miles' else '5 km')
                        qsf['SurveyElements'][32]['Payload']['QuestionText'] = QID1211340641
                        ...
                        qsf['SurveyElements'][33]['Payload']['QuestionText'] = QID1211340642
